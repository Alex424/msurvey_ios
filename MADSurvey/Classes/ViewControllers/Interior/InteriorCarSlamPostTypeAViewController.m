//
//  InteriorCarSlamPostTypeAViewController.m
//  MADSurvey
//
...
#import "InteriorCarSlamPostTypeAViewController.h"
#import "Constants.h"
#import "DataManager.h"

@interface InteriorCarSlamPostTypeAViewController () <UITextFieldDelegate>
{
...
@implementation InteriorCarSlamPostTypeAViewController
//InteriorCarSlamPostTypeAViewController
...
- (IBAction)next:(id)sender {
    ...
    if (index < textFields.count - 1) {
        ...
        [self performSegueWithIdentifier:UINavigationIDInteriorCarTypeAToFront sender:nil];
    }
}
/*
...
- (IBAction)center:(id)sender {
    ...
    [HelpView showOnView:[(AppDelegate*)[UIApplication sharedApplication].delegate window] withTitle:@"Car Interior Measurements" withImageName:@"img_help_45_interior_car_slam_post_type_a_help"];
}
