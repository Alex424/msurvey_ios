//
//  HallInstranceTransomMeasurementCenterViewController.m
//  MADSurvey
//
...
#import "HallInstranceTransomMeasurementCenterViewController.h"
#import "AppDelegate.h"
#import "Constants.h"
#import "DataManager.h"

@interface HallInstranceTransomMeasurementCenterViewController ()
...
@implementation HallInstranceTransomMeasurementCenterViewController
...
- (IBAction)next:(id)sender {
    ...
    if (index < textFields.count - 1) {
        ...
        [self performSegueWithIdentifier:UINavigationIDHallInstranceCenterNotes sender:nil];
    }
}

- (IBAction)center:(id)sender {
    [self.view endEditing:YES];
    [HelpView showOnView:[(AppDelegate*)[UIApplication sharedApplication].delegate window] withTitle:@"Hall Entrance Measurements" withImageName:@"img_help_54_hall_entrance_front_transom_center_measurements_help"];
}
