//
//  InteriorCarBackDoorViewController.m
//  MADSurvey
//
...
#import "InteriorCarBackDoorViewController.h"
#import "Constants.h"
#import "DataManager.h"

@interface InteriorCarBackDoorViewController ()

@end

@implementation InteriorCarBackDoorViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.title = @"Interior Car Back Door";
...
-(IBAction)comboAction:(id)sender
{
    ...
    InteriorCar *interiorCar = [DataManager sharedManager].currentInteriorCar;
    interiorCar.isThereBackDoor = btnSelected.tag == 0 ? 1 : 2;
...
- (IBAction)next:(id)sender {
    [self performSegueWithIdentifier:UINavigationIDInteriorCarFlooring sender:nil];
}
