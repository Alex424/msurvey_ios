//
//  HallInstranceTransomMeasurement1sViewController.m
//  MADSurvey
//
...
#import "HallInstranceTransomMeasurement1sViewController.h"
#import "AppDelegate.h"
#import "Constants.h"
#import "DataManager.h"

@interface HallInstranceTransomMeasurement1sViewController ()
{
...
@implementation HallInstranceTransomMeasurement1sViewController
...
- (IBAction)next:(id)sender {
    NSArray *textFields = @[aField, bField, cField, dField, eField, fField, gField];
    ...
    if (index < textFields.count - 1) {
        ...
        [self performSegueWithIdentifier:UINavigationIDHallInstrance1sNotes sender:nil];
    }
}

- (IBAction)center:(id)sender {
    [self.view endEditing:YES];
    [HelpView showOnView:[(AppDelegate*)[UIApplication sharedApplication].delegate window] withTitle:@"Hall Entrance Measurements" withImageName:@"img_help_55_hall_entrance_transom_measurements_1s_help"];
}
