//
//  InteriorCarSingleSideReturnMeasurementsAViewController.m
//  MADSurvey
//
...
#import "InteriorCarSingleSideReturnMeasurementsAViewController.h"

#import "Constants.h"
#import "DataManager.h"

@interface InteriorCarSingleSideReturnMeasurementsAViewController () <UITextFieldDelegate>
{
...
@implementation InteriorCarSingleSideReturnMeasurementsAViewController

//InteriorCarSingleSideReturnMeasurementsAViewController
...
- (IBAction)next:(id)sender {
    NSArray *textFields = @[aField, bField, cField, dField, eField, heightField];
    ...
    if (index < textFields.count - 1) {
        ...
        [self performSegueWithIdentifier:UINavigationIDInteriorCarDoorSingleSideAToDoorType sender:nil];
    }
}
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    dField.text = door.leftSideD >= 0 ? [formatter stringFromNumber:@(door.leftSideD)] : @"";
    eField.text = door.leftSideE >= 0 ? [formatter stringFromNumber:@(door.leftSideE)] : @"";
...
- (IBAction)center:(id)sender {
    ...
    [HelpView showOnView:[(AppDelegate*)[UIApplication sharedApplication].delegate window] withTitle:@"Car Interior Measurements" withImageName:@"img_help_46_interior_car_single_side_return_measurements_a_help"];
}
